export const MesasSection = ({ showCrud = true }) => {
  return (
    <section className="marble-surface rounded-3xl border border-stone-200/70 p-6 shadow-[0_18px_45px_-30px_rgba(80,62,43,0.45)] backdrop-blur-sm">
      ...
      <h3 className="mt-2 text-2xl font-bold text-stone-900">Mesas</h3>
      <p className="mt-2 text-sm text-stone-600">Visualiza distribución de mesas y disponibilidad en sala.</p>
      {showCrud && (
      ...
      <div className="mt-5 grid grid-cols-2 gap-3">
        <article className="rounded-2xl border border-stone-200 bg-white/75 p-3">
          ...
          <p className="mt-1 text-lg font-bold text-emerald-700">12</p>
        </article>
        <article className="rounded-2xl border border-stone-200 bg-white/75 p-3">
          <p className="text-xs text-stone-500">Ocupadas</p>
          <p className="mt-1 text-lg font-bold text-amber-700">7</p>
        </article>
      </div>
    </section>
  );
